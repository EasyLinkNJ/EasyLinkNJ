...
/**
 * Ex框架的装饰view，实现了title左中右的根布局，基本替代了
 * @author yhb
 */
public class ExDecorView extends RelativeLayout {
	...
	public void setContentView(View v, LayoutParams rllp) {

		if (rllp == null) {

			rllp = new LayoutParams(LayoutParams.MATCH_PARENT,
	...
	private LayoutParams getRelativeHoriMatchLayoutParamsByTitleHeight() {

		return new LayoutParams(LayoutParams.MATCH_PARENT,
				mStyle.mTitleHeight > 0 ? mStyle.mTitleHeight : LayoutParams.WRAP_CONTENT);
	}
