 ...
 */
public class ProductListNongjiPop extends PopupWindow {
    ...
    public ProductListNongjiPop(Context context) {
        super(context);
        // data
    ...
    public void updateBrand(List<BrandNongji> brands){

        listType = TYPE_BRAND;
        mBrandList = brands;
    }

    public void updateCategory(List<CategoryNongji> categoryList){
