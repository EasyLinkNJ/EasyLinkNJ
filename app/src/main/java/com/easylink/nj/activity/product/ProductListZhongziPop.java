 ...
 */
public class ProductListZhongziPop extends PopupWindow {
    ...
    public ProductListZhongziPop(Context context) {
        super(context);
        // data
    ...
    public void updateBrand(List<BrandZhongzi> brands){

        listType = TYPE_BRAND;
        mBrandList = brands;
    }

    public void updateCategory(List<CategoryZhongzi> categoryList){
