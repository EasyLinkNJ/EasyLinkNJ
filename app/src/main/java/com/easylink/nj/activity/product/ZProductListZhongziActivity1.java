 ...
 */
public class ZProductListZhongziActivity1 extends ProductListActivity<ProductZhongziList> implements OnItemViewClickListener{
    ...
    public static void startActivity(Activity activity, String companyId){
        ...
        intent.setClass(activity, ZProductListZhongziActivity1.class);
