 ...
 */
public class ProductListNongyaoPop extends PopupWindow {
    ...
    public ProductListNongyaoPop(Context context) {
        super(context);
        // data
    ...
    public void updateBrand(List<BrandNongyao> brands){

        listType = TYPE_BRAND;
        mBrandList = brands;
    }

    public void updateCategory(List<CategoryNongyao> categoryList){
